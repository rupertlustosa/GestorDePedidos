<template>
    <div>
        ...
        <orderType-nav-bar-component></orderType-nav-bar-component>
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="form-row">
                                <div class="form-group col-12">
                                    ...
                                    <router-link :to="{ name: 'order_types.list' }" class="btn btn-white">
...
<script>
    import OrderTypeNavBarComponent from "./OrderTypeNavBarComponent";
    import FormErrorComponent from "../../../../../resources/js/components/layout/bootstrap/FormErrorComponent";

    export default {
        name: "OrderTypeFormComponent",
        components: {FormErrorComponent, OrderTypeNavBarComponent},
        data() {
            return {
                routeToSave: "/api/order_types",
                routeNameToRedirect: "order_types.list",
                method: 'post',
                form: {},
                errors: {},
                isCreateMode: true,
        ...
        methods: {
            ...
            saveAndNew() {
                ...
                this.routeNameToRedirect = 'order_types.create';
                this.save();
            },
            save() {
                    ...
                    .then(response => {
                        ...
                        this.$router.push({name: this.routeNameToRedirect})
                            ...
                            .then(() => {
                                ...
                                this.form = {};
                                this.routeNameToRedirect = "order_types.list";
                            });
        ...
        mounted() {
            ...
            if (typeof (this.$route.params.id) !== "undefined") {
                ...
                this.routeToSave = "/api/order_types/" + this.$route.params.id;
                this.method = 'put';
                this.getData();
            }
        }
