<template>
    <div>
        ...
        <orderStatus-nav-bar-component></orderStatus-nav-bar-component>
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="form-row">
                                <div class="form-group col-12">
                                    ...
                                    <router-link :to="{ name: 'order_statuses.list' }" class="btn btn-white">
...
<script>
    import OrderStatusNavBarComponent from "./OrderStatusNavBarComponent";
    import FormErrorComponent from "../../../../../resources/js/components/layout/bootstrap/FormErrorComponent";

    export default {
        name: "OrderStatusFormComponent",
        components: {FormErrorComponent, OrderStatusNavBarComponent},
        data() {
            return {
                routeToSave: "/api/order_statuses",
                routeNameToRedirect: "order_statuses.list",
                method: 'post',
                form: {},
                errors: {},
                isCreateMode: true,
        ...
        methods: {
            ...
            saveAndNew() {
                ...
                this.routeNameToRedirect = 'order_statuses.create';
                this.save();
            },
            save() {
                    ...
                    .then(response => {
                        ...
                        this.$router.push({name: this.routeNameToRedirect})
                            ...
                            .then(() => {
                                ...
                                this.form = {};
                                this.routeNameToRedirect = "order_statuses.list";
                            });
        ...
        mounted() {
            ...
            if (typeof (this.$route.params.id) !== "undefined") {
                ...
                this.routeToSave = "/api/order_statuses/" + this.$route.params.id;
                this.method = 'put';
                this.getData();
            }
        }
